...
<head>
	...
	<title> Association Charite et bienfaisance </title>
</head>
<body>
	<header>
		<?php 
	...
	<main>
		...
		<h1>
			Association charité et bienfaisance pour la promotion des non-voyants
			(ACBPNV)
		</h1>
		...
		<p>
			...
			<ul>
				<li>mettre tous dans le sillage du plan Sénégal émergent (PSE) qui vise à mettre en place d’ici à 2025, un ensemble de projets structurants à fort contenu de valeur ajoutée et d’emploi ;</li>
				...
				<li>Créer un cadre d’entraide pour trouver des partenaires locaux nationaux et internationaux pour créer des activités de développement autonome ; </li>
				...
				<li>Agriculture et élevage : transformation de produits agricoles, aviculture… ; </li> 

				<li>Commerce : poissonnerie et commerce… ;</li>

				<li>Renforcement des capacités techniques et professionnelles des membres ; </li>
				...
				<li>Niveau intermédiaire 5 années. </li>
				...
				<li>Mise à profit du trilinguisme (travail sur les langues nationales comme entrée ; la langue nationale sera un outil d’acquisition de connaissances). </li>
				...
				<li>Des modules d’entreprenariat et de leadership vont accompagner et préparer les jeunes à l’insertion. </li>

				<li>Le programme intermédiaire sera hybridé en ce sens qu’il englobe la formation professionnelle et générale dans la limite des besoins de chaque filière et en fonction de l’utilité des savoirs à acquérir et à mobiliser dans la formation au métier cible. Il s’agira d’un programme de formation centré sur les qualifications visées. Toutefois un module transversal en rapport avec la citoyenneté éclairée par la religion sera donné à toutes les filières.</li> 

				<li>Recherche de financement pour des projets et activités porteurs sélectionnés et validés en fin de formation. </li> 
